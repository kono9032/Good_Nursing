...
import signal
Socket = None
def signal_handler(sig, frame): # 강제 종료 시, 서버안전 장치
    try:
        Socket.close()
    except:
        pass
...
signal.signal(signal.SIGINT, signal_handler) # ctrl + c 키보드 인터럽트
